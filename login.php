        ...
        if(isset($_POST["loginInputEmail"]) && isset($_POST["loginInputPass"])){
            ...
            if($row = $query->fetch()){
                ...
                if($row = $query->fetch()){
                    ...
                    appendLog("S", "The user successfully connected " . $_POST["loginInputEmail"] . " and the password ".$_POST['loginInputPass']);
                    ...
                    array_push($_SESSION["arrayMensajesCSS"],array($tipo,$mensajeCSS));
                    echo "<script type='text/javascript'>mostrarMensajeCSS('".$tipo."','".$mensajeCSS."')</script>";
                    appendLog("W", "The user tried to connect" . $_POST["loginInputEmail"] . " and the password ".$_POST['loginInputPass']);
                }
            }else{
                $tipo = "error";
                $mensajeCSS = "Usuari o contrasenya incorrecte";
